/* Generated By:JavaCC: Do not edit this line. ReadPlacementTokenManager.java */
package PlacementParser;
import java.io.*;

/** Token Manager. */
public class ReadPlacementTokenManager implements ReadPlacementConstants
{
...
/** Constructor. */
public ReadPlacementTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public ReadPlacementTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
