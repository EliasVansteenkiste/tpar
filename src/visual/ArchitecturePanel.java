...
public class ArchitecturePanel extends JPanel {
	...
	public ArchitecturePanel(int size, FourLutSanitizedDisjoint a, final Circuit c) {
		this.a = a;
	...
	private void drawClbSite(double x, double y, double angle, Site s) {
		...
		//TODO needs to be adapted for architectures with variable number of inputs and outputs per clb
		drawNode(site.source, x + 0.3 * clbWidth, y - 0.2 * clbWidth);
		drawNode(site.opin.get(0), x + 0.3 * clbWidth, y - 0.4 * clbWidth);
